...
class BusinessCategoryController extends Controller {
  ...
  public function __construct()
	...
	public function index(Request $request)
	{
		...
		if($name!="")
		{ 
			$business_category_data = $business_category_data->where('name','like',"%$name%");
		}
		...
		if ($request->ajax()) 
		{
			return view('admin.business-category.search', compact('business_category_data'));  
        }
		$admindata = Admin::find(session('admin')['id']);

        return view('admin.business-category.show', compact('business_category_data','admindata'));
	}

	//-------------business category -feb-2021---------
	public function addbusinesscategory(Request $request)
	{
		return view('admin.business-category.add');
	} 
	//-------------business category -feb-2021---------
	...
	public function editbusinesscategory($id)
	{
		...
		return view('admin.business-category.edit',["business_category_data" => $business_category_data]);
	}
	...
	public function viewbusinesscategory($id)
	{
		...
		->first();
		return view('admin.business-category.view',["businessCategoryData" => $businessCategoryData]);
	}
