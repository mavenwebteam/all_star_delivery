...
class BannerController extends Controller {
  	public function index(Request $request)
	{
		if($request->ajax()){
			...
			return view('admin.banners.search', compact('data'));	
			die;
		}
		$data = Banner::with(['businessCategory','store'])->whereNull('deleted_at')
		->orderBy('created_at','DESC')
	...
	{   
		...
		->orderBy('name_en','ASC')
		->get();
		return view('admin.banners.add', compact('businessCategory'));		
    } 
	...
	public function edit($id)
	{
		...
		->get();
		return view('admin.banners.edit', compact('businessCategory','banner','stores'));
    }
