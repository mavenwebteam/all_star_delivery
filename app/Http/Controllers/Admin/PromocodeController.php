...
class PromocodeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            return view('admin.promocode.search', compact('promocodes'));
        }
        
        return view('admin.promocode.show', compact('promocodes'));
    }

    function showongoingpromo(){
        $promocodes = Promocode::with('businessCategory')->whereNull('deleted_at');
        $promocodes = $promocodes->where('status', '1');
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.promocode.add', compact('businessCategories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.promocode.edit', compact('promocode','businessCategories'));
    }
