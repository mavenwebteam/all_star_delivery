...
class UsersController extends Controller {
  private $admin;
	...
	{	
		...
		if ($request->ajax()) 
		{
			return view('sub_admin.users.search', compact('userdata'));
			die;
        }
        return view('sub_admin.users.show', compact('userdata'));
	}
	...
	public function adduser(Request $request)
	{
		...
		return view('sub_admin.users.add',compact('countrycode_box'));
	} 
...

	{
		...
		return view('sub_admin.users.edit',["userdata" => $userdata,"countrycode_box" => $countrycode_box]);
	...
	public function viewuser($id)
	{
		$userId = base64_decode($id);
		$userdata = User::find($userId);
		return view('sub_admin.users.view',["userdata" => $userdata]);
