...
class StoresController extends Controller {
    ...
    public function index(Request $request) {
        ...
        if ($request->ajax()) {
            return view('sub_admin.store.search', compact('storedata'));
        }
        $admindata = Admin::find(session('admin') ['id']);
        return view('sub_admin.store.show', compact('storedata', 'admindata'));
    }
    ...
    public function addstore(Request $request) {
        ...
        return view('sub_admin.store.add', ['user_box' => $user_box, 'businessCategoryList' => $businessCategoryList, 'countrycode_box' => $countrycode_box]);
    }
    ...
    public function editstore($id) {
        ...
        return view('sub_admin.store.edit', ["storedata" => $storedata, 'user_box' => $user_box, 'countryList' => $countryList, 'stateList' => $stateList, 'cityList' => $cityList, 'vendordata' => $vendordata, 'countrycode_box' => $countrycode_box, 'businessCategoryList' => $businessCategoryList]);
    }
    ...
    public function editstorepost(Request $request) {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'comission' => 'required|numeric|gt:0|max:99', 
    ...
    */
    ...
    public function getStoreItems(Request $request, $id) {
        ...
        if ($request->ajax()) 
		{
			return view('sub_admin.store.product-table', compact('products'));
			die;
        }

        return view('sub_admin.store.products', compact('store','products','itemCategories'));
    }


    public function getState($id = null) {
        $stateList = DB::table('states')->where('country_id', $id)->pluck('name', 'id')->all();
        return view('sub_admin.store.state', ["stateList" => $stateList]);
    }
    public function getCity($id = null) {
        ...
        return view('sub_admin.store.city', ["cityList" => $cityList]);
    }
    public function viewstore($id) {
        ...
        return view('sub_admin.store.view', ["storedata" => $storedata]);
    }
