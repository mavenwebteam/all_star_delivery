...
class ItemCategoryController extends Controller {
  ...
  public function __construct()
	...
	public function index(Request $request)
	{
		...
		if ($request->ajax())
		{
			return view('sub_admin.item-category.search', compact('catedata'));
		}
		$admindata = Admin::find(session('admin')['id']);
		return view('sub_admin.item-category.show', compact('catedata','admindata','businessCategories'));
	}
	...
	public function addcategory(Request $request)
	{
		...
		return view('sub_admin.item-category.add');
	} 
	...
	public function editcategory($id)
	{
		...
		return view('sub_admin.item-category.edit',["catdata" => $catdata]);
...

	{
		...
		return view('sub_admin.category.import_category');
...
public function viewcategory($id)
...

	{
		...
		return view('sub_admin.item-category.view',["catData" => $catData]);
