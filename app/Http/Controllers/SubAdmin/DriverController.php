  ...
  private $admin;
	...
	public function index(Request $request)
	{
		if($request->ajax()){
			...
			return view('sub_admin.drivers.search', compact('driverData'));	
			die;
		}
		...
		return view('sub_admin.drivers.show', compact('driverData'));
	}
	...
	{   
		return view('sub_admin.drivers.add');		
    } 
	...
	public function edit($id)
	{
		...
		if($data)
		{
			return view('sub_admin.drivers.edit',compact('data'));
		}else{
	...
	public function show($id)
	{
		...
		if($driverData)
		{
			return view('sub_admin.drivers.view',compact('driverData'));
		}else{
			return response()->json(['warning' => 'Driver Not found !']);
		}
	}
