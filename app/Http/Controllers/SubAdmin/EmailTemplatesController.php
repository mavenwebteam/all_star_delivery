...
class EmailTemplatesController extends Controller {
  ...
  public function __construct()
...

	{
        ...
        if ($request->ajax()) 
		{
			return view('sub_admin.email-templates.search', compact('email_templates_data'));  
        }
		$admindata = Admin::find(session('admin')['id']);

		return view('sub_admin.email-templates.show', compact('email_templates_data','admindata'));
...

	{
		...
		$email_templates_data =$email_templates_data->paginate(10);
		 $src = "";
		 return view('sub_admin.email-templates.search',['email_templates_data'=>$email_templates_data,'src'=>$src ]);	
	}
...

	{
		...
		return view('sub_admin.email-templates.edit',["email_templates_data" => $email_templates_data]);
