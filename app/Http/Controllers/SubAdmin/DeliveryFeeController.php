...
class DeliveryFeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sub_admin.delivery-fee.show', compact('customerFee', 'driverFee', 'radius'));
    }
    ...
    {
		return view('sub_admin.delivery-fee.add');
    }
    ...
    public function edit($id)
    {
		...
		return view('sub_admin.delivery-fee.edit',["feeData" => $feeData]);
    }
