...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            return view('sub_admin.orders.table', compact('orders'));
        }
        return view('sub_admin.orders.index', compact('orders'));
    }
    ...
    public function edit($id){
        ...
        return view('sub_admin.orders.edit', compact('order','drivers', 'assignedDriver'));
    ...
    public function show($id)
    {
        ...
        if($order){
            return view('sub_admin.orders.show', compact('order'));
        }
    }
