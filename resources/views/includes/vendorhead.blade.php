...
{{-- matiral switech button --}}
<link href="{{ asset('assets/css/switech.css') }}" rel="stylesheet">
...
<!-- timepicker -->
<script src="{{ asset('admin_assets/bower_components/bootstrap-timepicker/js/bootstrap-timepicker.js') }}"></script>
<!-- Bootstrap WYSIHTML5 -->
...
{{-- <script src="{{ asset('admin_assets/dist/js/dashboard21.js') }}"></script> --}}
