...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ URL::to('/vendor/delivery-boy-logs') }}',
    ...
    function view_record(view_id) {
        ...
        $('#UserModal').load('{{ URL::to('/vendor/view-orders') }}'+'/'+view_id);
        $("#myModal").modal();
		}else{
			location.reload();
				$.LoadingOverlay("hide");
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/vendor/orders') }}');
    })

</script>
<section class="content-header"><h1>Delivery boy Logs</h1>
      <ol class="breadcrumb">
        <li><a href="{{url('/vendor')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Delivery boy Logs</li>
      </ol>
</section>
<section class="" style="padding: 15px;">
      <div class="row">
        <div class="col-xs-12 page-user">
          <div class="box">
            <div class="box-body">
            {!! Form::open(array('url' => '/vendor/delivery-boy-logs', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
...
<section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Delivery boy Logs Table</h3>
            </div>
            <!-- /.box-header -->
    ...
    @if($i<2)
    <tr>
    <td colspan="13">No Delivery boy Logs Data</td>
    </tr>
    @endif    
    </tbody> 
