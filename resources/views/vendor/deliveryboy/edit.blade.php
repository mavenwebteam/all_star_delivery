<script type="text/javascript">
		...
		if(checklogin1  == true){	
            ...
            $.ajax({
                dataType: 'json',
                    ...
                    cache: false,
                    processData:false,         
            url: '{{ URL::to('/vendor/edit-delivery-boy-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/vendor/edit-delivery-boy-post', 'method' => 'post','name'=>'editUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'editUserForm')) !!}
            ...
            <div class="panel-body">
               ...
               <!-- <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::select('type',$helper->SelectUserTypeBoy(),$userdata->type, ['class' => 'form-control','required'=>'required','id'=>'type','onkeypress' => 'error_remove()']) !!}
                            </div>
					 ...
					 <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::select('vehicle_type',$vehical_box,$userdata->vehicle_type, ['class' => 'form-control','required'=>'required','id'=>'vehicle_type','onkeypress' => 'error_remove()']) !!}
                            </div>
					 ...
					 <div class="row">
					   <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8 col-sm-6 col-xs-12">
                            {!! Form::text('cash_limit_per_day',$userdata->cash_limit_per_day, ['class' => 'form-control','placeholder' => 'Cash Limit Per Day','required'=>'required','id'=>'cash_limit_per_day','onkeypress' => 'error_remove()' ]) !!}   
                            </div>
                        </div>
                    </div>
					<div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8 col-sm-6 col-xs-12">
                            {!! Form::text('vehicle_number_plate',$userdata->vehicle_number_plate, ['class' => 'form-control','placeholder' => 'Vehicle number plate','required'=>'required','id'=>'vehicle_number_plate','onkeypress' => 'error_remove()' ]) !!}   
                            </div>
                        </div>
                    </div>
					</div>
