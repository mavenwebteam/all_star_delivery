<script type="text/javascript">
        ...
        {    $.LoadingOverlay('show');
            ...
            $.ajax({
                dataType: 'json',
                    ...
                    cache: false,
                    processData:false,         
            url: '{{ URL::to('/vendor/edit-picker-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/vendor/edit-picker-post', 'method' => 'post','name'=>'editUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'editUserForm')) !!}
				   ...
				   <div class="col-12 col-sm-12 col-md-6">
					<div class="row form-group">
							...
							<div class="col-lg-8 col-sm-6 col-xs-12">
									...
									{!! Form::select('outlet_id',$store_box,$userdata->outlet_id, ['class' => 'form-control','required'=>'required','id'=>'outlet_id','onChange' => 'error_remove()' ]) !!}
							</div>
					</div>
				</div>
				<!--<div class="col-12 col-sm-12 col-md-6">
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
					 ...
					 <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8 col-sm-6 col-xs-12">
                            <div class="row">
                                <div class="col-lg-5 col-sm-6 col-xs-12 pr-0">
                                ...
                                <div class="col-lg-7 col-sm-6 col-xs-12 pr-0">
