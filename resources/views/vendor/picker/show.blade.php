...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        loadPiece( '{{ URL::to('/vendor/picker') }}');
    })
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Picker</li>
      </ol>
    </section>
    <section class="{{url('/vendor')}}" style="padding: 15px;">
      <div class="row">
        <div class="col-xs-12 page-user">
          <div class="box">
            <div class="box-body">
            {!! Form::open(array('url' => '/vendor/search-picker', 'method' => 'post','name'=>'mySearchForm','files'=>true,'novalidate' => 'novalidate','id' => 'mySearchForm')) !!}
          ...
          <!-- <div class="col-xs-12 col-sm-6 col-md-3">
           ...
           <div class="col-xs-12 col-sm-6 col-md-12">
                ...
                <a href="javascript:" style="margin-top: 20px;" class="custom-btn pull-right btn btn-outline-primary btn-labeled" onclick="add_record();" title="Add Picker"><span class="btn-label icon fa fa-plus"></span>Add Picker</a>
          </div>
            {!! Form::close() !!}
            </div>
        </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Picker Data Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" id="replace-div">
                 @include('vendor.picker.search')
            </div>
            <!-- /.box-body -->
          </div>
