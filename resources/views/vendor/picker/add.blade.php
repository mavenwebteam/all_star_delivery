<script type="text/javascript">
    ...
    {   $.LoadingOverlay('hide');
		...
		if(checklogin1  == true){	
            ...
            url: '{{ URL::to('/vendor/add-picker-post') }}',
  ...
  $.LoadingOverlay('hide');
    ...
    {!! Form::open(array('url' => '/vendor/add-picker-post', 'method' => 'post','name'=>'addUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'addUserForm')) !!}
				...
				<div class="col-12 col-sm-12 col-md-6">
					<div class="row form-group">
							...
							<div class="col-lg-8 col-sm-6 col-xs-12">
									...
									{!! Form::select('outlet_id',$store_box,null, ['class' => 'form-control','required'=>'required','id'=>'outlet_id','onChange' => 'error_remove()' ]) !!}
							</div>
					</div>
				</div>
              <!--  <div class="col-12 col-sm-12 col-md-6">
                   ...
                   {!! Form::text('mobile',null, ['class' => 'form-control','placeholder' => 'Mobile ','required'=>'required','id'=>'mobile','onkeypress' => 'error_remove()' ]) !!}   
					...
					<!-- <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::text('address',null, ['class' => 'form-control address','placeholder' => 'Address ','required'=>'required','id'=>'address','onkeypress' => 'error_remove()', 'autocomplete'=>'off' ]) !!}
