<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
        $( '#addContentForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({			dataType: 'json',            type: "POST",            data:  new FormData(this),            contentType: false,            cache: false,            processData:false,
        ...
        <div class="panel form-horizontal panel-transparent">
            <div class="panel-body">
                ...
                <div class="col-12 col-sm-12 col-md-12">
                        ...
                        </div>						 <div class="col-12 col-sm-12 col-md-12">                            <div class="row form-group">                                <label class="col-lg-2 col-sm-6 col-xs-12 control-label">Recipients <span class="red-star">*</span></label>                                <div class="col-lg-10 col-sm-6 col-xs-12">                                    All Users <input type="radio" name="type" id=""  value="0"> 									 All Delivery Boys  <input type="radio" name="type" id="type" value="2">                                </div>                            </div>                        </div>
