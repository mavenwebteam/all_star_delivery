<script type="text/javascript">
    ...
    {   $.LoadingOverlay('hide');
		...
		if(return_quantity <= quantity){	
            ...
            url: '{{ URL::to('/admin/add_return_item') }}',
        ...
        {  error_remove (); if(data.success==false)
			...
			alert("Return Quenty not greater then actual quenty");
		}
    ...
    {!! Form::open(array('url' => '/admin/add_return_item', 'method' => 'post','name'=>'addUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'addUserFormdata')) !!}
