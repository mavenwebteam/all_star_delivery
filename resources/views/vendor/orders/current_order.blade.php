...
@section('title')
{{Config::get("Site.title")}} | Current Orders List
@stop
@section('content') 

  <section class="content-header"><h1>{{ __('vendor.current_orders') }}</h1>
    <ol class="breadcrumb">
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body" id="table-div">
                @include('vendor.orders.current_order_table')
          </div>
          <!-- /.box-body -->
        </div>
...
@push('script')
  ...
  <script type="text/javascript">
    ...
    function search() {
      ...
      $.ajax({
        type: "GET",
        url: '{{ URL::to('vendor/orders/order-history/current-orders') }}',
