<script type="text/javascript">
        ...
        $( '#addProductInventory' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
               ...
               type: "POST",
                ...
                cache: false,
                 processData:false,
                  url: '{{ URL::to('/admin/import-product-inventory-post') }}',
    ...
    {!! Form::open(array('url' => '/admin/import-product-inventory-post', 'method' => 'post','name'=>'addProductInventory','files'=>true,'novalidate' => 'novalidate','id' => 'addProductInventory')) !!}

    <a href="{{asset('/media/sample_product_inventory.xlsx')}}">Download Sample File</a>
