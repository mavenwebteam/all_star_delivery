...
<script type="text/javascript">
    ...
    function exportData() {
        ...
        window.location.href = '{{ URL::to('/admin/export-vendor') }}'+'?user_search_name='+user_search_name+
    ...
    function add_record() {
        ...
        $.LoadingOverlay("show");
        $('#UserModal').html(''); $(".form-title").text('Add Vendor');
    ...
    function edit_record(edit_id) {
        ...
        $.LoadingOverlay("show");
        $('#UserModal').html(''); $(".form-title").text('Edit Vendor');
    ...
    <section class="" style="padding: 15px;">
      <div class="row">
        <div class="col-xs-12 page-user">
          <div class="box">
            <div class="box-body">
            {!! Form::open(array('url' => '/admin/search-vendor', 'method' => 'post','name'=>'mySearchForm','files'=>true,'novalidate' => 'novalidate','id' => 'mySearchForm')) !!}
            <div class="col-xs-12 col-sm-6 col-md-3">
            <label></label>
            {!! Form::text('username',null, ['class' => 'form-control','id'=>'user_search_name','placeholder'=>'Name']) !!}
           </div>
		    <div class="col-xs-12 col-sm-6 col-md-3">
            <label></label>
