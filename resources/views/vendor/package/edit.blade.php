...
$(document).ready(function () 
    {  $.LoadingOverlay("hide");
        $( '#editCityForm' ).on( 'submit', function(e) 
        {
            ...
            cache: false,
            processData:false,
            url: '{{ URL::to('/admin/edit-package-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/admin/edit-package-post', 'method' => 'post','name'=>'editCashlimitForm','files'=>true,'novalidate' => 'novalidate','id' => 'editCityForm')) !!}
                ...
                <div class="alert alert-danger" style="display:none"></div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::hidden('id',base64_encode($Packagedata->id),['id'=>'id']) !!}

              {!! Form::select('vendor_id',$helper->GetVendorList(),$Packagedata->vendor_id, ['class' => 'form-control','id'=>'vendor_id' ]) !!}                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        {!! Form::text('name',$Packagedata->name, ['class' => 'form-control','placeholder' => 'Name','required'=>'required','id'=>'name']) !!}
                    ...
                    <div class="row form-group">
                        ...
                        {!! Form::text('days',$Packagedata->days, ['class' => 'form-control','placeholder' => 'Days','required'=>'required','id'=>'days','onkeypress' => "return isNumberKey(event)" ]) !!}
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8 col-sm-6 col-xs-12">
                            {!! Form::text('amount',$Packagedata->amount, ['class' => 'form-control decimal','placeholder' => 'Amount','required'=>'required','id'=>'amount' ]) !!}
                            </div>
