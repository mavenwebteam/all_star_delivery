        ...
        {   
            ...
            {	
                ...
                $.ajax({
                    ...
                    cache: false,
                    processData: false,
                    url: '{{ route("subAdmin.orders.update",$order->id) }}',
                }).done(function(data){ 
                    console.log(data);
                    error_remove ();
                    $.LoadingOverlay("hide");  
...
{!! Form::open(array('url' => route('subAdmin.orders.update',$order->id), 'method' => 'post', 'name'=>'orderForm','files' =>'true','novalidate' => 'novalidate','id' => 'orderForm')) !!}
    @method('PUT')    
