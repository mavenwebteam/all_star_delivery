    ...
    <section class="" style="padding: 15px;">
        <div class="row">
            <div class="col-xs-12 page-user">
                <div class="box">
                    <div class="box-body">
                    {!! Form::open(array('url' => '/sub-admin/store', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'searchForm')) !!}
       ...
       <div class="col-xs-12">
          ...
          <div class="box-header">
            ...
            <div class="box-body" id="table-div">
                @include('sub_admin.store.product-table')
            </div>
          </div>
       </div>
    </div>
...
@push('script')
    <script>
        ...
        $.ajax({
            ...
            url: '{{ URL::to('sub-admin/store/menu-items') }}'+'/'+ {{ $store->id }},
