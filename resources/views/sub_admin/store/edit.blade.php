        ...
        {    $.LoadingOverlay("show");
           ...
           // CKEDITOR.instances[instanceName].updateElement();
            $.ajax({
                ...
                processData:false,
                type: "POST",
                url: '{{ URL::to('/sub-admin/edit-store-post') }}',
        }).done(function( data ) 
...
<section class="content-header">
 ...
 <section class="" style="padding: 15px;">
    ...
    <div class="box">
       <div class="box-body">
          {!! Form::open(array('url' => '/sub-admin/edit-store-post', 'method' => 'post','name'=>'editStoreForm','files'=>true,'novalidate' => 'novalidate','id' => 'editStoreForm')) !!}
