   ...
   {  
      ...
      {   
         $.LoadingOverlay('show');
           ...
           //CKEDITOR.instances[instanceName].updateElement();
              ...
              cache: false,
              processData:false,
              url: '{{ URL::to('/sub-admin/add-store-post') }}',
          }).done(function( data ) 
          {  
            error_remove (); 
            if(data.success==false)
            {
               ...
               { 	
                  ...
                  window.location = '{{ URL::to('/sub-admin/store') }}';
                  return false;
            }
            $.LoadingOverlay('hide');
       });
      ...
      // --------local vendors start-------
         ...
         $('#vendors').select2({
            ...
            ajax: {
                  url: '{{ route("subAdmin.vendor.list") }}',
                  dataType: 'json',
                  delay: 250,
                  pagination: {
                        more: true
   ...
   $(document).ready(function () { 
   		$( "#countary_id" ).change(function () {
   			var countary_id = $(this).val();
   				$.ajax({
   					url: "{{url('sub-admin/getstate') }}" + '/'+countary_id,
        ...
        $( "select[name='state_id']" ).change(function () { //alert();
   			var state_id = $(this).val();
   				$.ajax({
   					url: "{{url('sub-admin/getcity') }}" + '/'+state_id,
   					success: function(data) {
...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="{{url('sub-admin/store')}}">Store</a></li>
...
<section class="" style="padding: 15px;">
   ...
   <div class="box">
      <div class="box-body">
         {!! Form::open(array('url' => '/sub-admin/add-store-post', 'method' => 'post','name'=>'editStoreForm','files'=>true,'novalidate' => 'novalidate','id' => 'addUserForm')) !!}
            ...
            <div class="row form-btn text-center">
               <div class="col-sm-12 p-r-30">
                  <div class="col-md-12">
                     ...
                     <a href="{{URL::to('/sub-admin/store')}}">{!! Form::button('Cancel',['class' => 'btn btn-flat subbtn','data-dismiss'=>'modal']) !!}</a>
                  </div>
               </div>
               {!! Form::close() !!}
            </div>
