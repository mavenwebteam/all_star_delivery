...
$(document).ready(function() {
	...
	$('#addUserForm').on('submit', function(e) {
		...
		$.ajax({
			...
			cache: false,
			processData: false,
			url: '{{ URL::to('/sub-admin/add-vendor-post') }}',
		}).done(function(data) {
			error_remove();
...
</script> {!! Form::open(array('url' => '/sub-admin/add-vendor-post', 'method' => 'post','name'=>'addUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'addUserForm')) !!}
