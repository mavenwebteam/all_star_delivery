<script type="text/javascript">
        ...
        $( '#editUserForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
                dataType: 'json',
                    ...
                    cache: false,
                    processData:false,         
            url: '{{ URL("/sub-admin/edit-vendor-post")}}',
        }).done(function(data) 
    ...
    {!! Form::open(array('url' => '/sub-admin/edit-vendor-post', 'method' => 'post','name'=>'editUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'editUserForm')) !!}
