    ...
    {  $.LoadingOverlay("hide");
		...
		if(checklogin1  == true){	
           ...
           dataType: 'json',
            ...
            url: '{{ URL::to('/sub-admin/add-item-category-post') }}',
...
.users_select a {
    ...
    {!! Form::open(array('url' => '/sub-admin/add-item-category-post', 'method' => 'post','name'=>'addItemCategoryForm','files'=>true,'novalidate' => 'novalidate','id' => 'addItemCategoryForm')) !!}
