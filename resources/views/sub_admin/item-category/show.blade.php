...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            ...
            url: '{{ URL::to('/sub-admin/item-category') }}',
    ...
    function add_record() {
        ...
        $('#UserModal').load('{{ URL::to('/sub-admin/add-item-category') }}');
    ...
    function edit_record(edit_id) {
        ...
        $('#UserModal').load('{{ URL::to('/sub-admin/edit-item-category') }}'+'/'+edit_id);
    ...
    function view_record(view_id) {
        ...
        $('#UserModal').load('{{ URL::to('/sub-admin/view-item-category') }}'+'/'+view_id);
...

    {
      ...
      $.ajax({
            ...
            url: '{{ URL::to('/sub-admin/item-category-status') }}',
...
function selectImportBrand() {
    ...
    $('#UserModal').load('{{ URL("/sub-admin/import-item-category") }}');
...

    {
      ...
      $.ajax({
            ...
            url: '{{ URL::to('/sub-admin/item-category-remove') }}',
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/sub-admin/item-category') }}');
        ...
        <div class="col-xs-12 page-user">
          ...
          <div class="box">
           ...
           <div class="col-xs-12 col-sm-6 col-md-12">
                ...
                @if(in_array('subAdmin.add-item-category.index', $permissionData))
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" id="replace-div">
                 ...
                 @include('sub_admin.item-category.search')
