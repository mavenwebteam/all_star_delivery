...
<script type="text/javascript">
  ...
  function add_record() {
        ...
        if(checklogin1  == true){
          ...
          $('#feeModel').load('{{ URL::to('/sub-admin/add-delivery-fee') }}');
          $("#myModal").modal();
        }else {
          location.reload();	
          $.LoadingOverlay("hide");
  ...
  function edit_record(edit_id) {
      ...
      $('#feeModel').load('{{ URL::to('/sub-admin/edit-delivery-fee') }}'+'/'+edit_id);
  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
        @if(in_array('subAdmin.update.max-rdius', $permissionData))
        <div class="box">
          <div class="box-body">
          <div Class="col-md-8">
            <form method="post" action="{{ route('subAdmin.update.max-rdius') }}">
              @csrf
              @method('PUT')
        ...
        <div class="box">
          ...
          <div class="box-body" id="replace-div">
                @include('sub_admin.delivery-fee.search')
          </div>
          <!-- /.box-body -->
        </div>
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body" id="replace-div">
                @include('sub_admin.delivery-fee.driver-table')
          </div>
          <!-- /.box-body -->
        </div>
      </div>
