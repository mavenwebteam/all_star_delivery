        ...
        $('#editUserForm').on('submit', function(e) {
            ...
            if (checklogin1 == true) {
                ...
                $.ajax({
                    ...
                    cache: false,
                    processData: false,
                    url: '{{ URL::to('/sub-admin/delivery-fee-update') }}',
                }).done(function(data) {
                    error_remove();
...
{!! Form::open(array('url' => '/sub-admin/delivery-fee-update', 'method' => 'post','name'=>'editUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'editUserForm')) !!}
