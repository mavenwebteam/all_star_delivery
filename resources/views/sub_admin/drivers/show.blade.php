...
<script type="text/javascript">
    ...
    function searchItem() 
    {
        $.ajax({
            type: 'GET',
            url: '{{ route("subAdmin.drivers.index") }}',
    ...
    function fetchDataByPage(pageNo)
    {
      $.ajax({
      type: 'GET',
      url:"{{ url('sub-admin/drivers?page=') }}"+pageNo,
      data: $('#mySearchForm').serialize(),
      beforeSend: function(){
          $.LoadingOverlay("show");
      },
    ...
    function add_record() 
    {
      ...
      if(checklogin1  == true){
          ...
          $('#UserModal').load('{{ route("subAdmin.drivers.create") }}');
          $("#myModal").modal();
      }else{
        location.reload();
          $.LoadingOverlay("hide");
    ...
    function edit_record(edit_id) 
    {
      ...
      if(checklogin1  == true){
          ...
          $('#UserModal').load('{{ URL::to("sub-admin/drivers/") }}'+'/'+edit_id+'/edit');
          $("#myModal").modal();
          $.LoadingOverlay("hide");
      }else{
        location.reload();
    ...
    function view_record(view_id) 
    {
      ...
      if(checklogin1  == true){
          ...
          $('#UserModal').load('{{ URL::to("sub-admin/drivers/") }}'+'/'+view_id);
          $("#myModal").modal();
      }else{
        location.reload();
          $.LoadingOverlay("hide");
    ...
    {	
      ...
      if(checklogin1  == true){
        ...
        $.ajax({
              ...
              data: { id:id}, 
              type: "POST",
              url: '{{ URL::to('/sub-admin/drivers/status') }}',
          }).done(function( data ) 
          {   
            searchItem();
    ...
    function remove_record(id) 
    {
      ...
      if(checklogin1  == true){
        ...
        $.ajax({
              ...
              data: { id:id}, 
              type: "DELETE",
              url: '{{ URL::to('sub-admin/drivers') }}'+'/'+id,
          }).done(function( data ) 
          {   
            searchItem();
            if(data.class == 'success')
      ...
      <div class="box">
        ...
        {!! Form::open(array('route' => 'admin.drivers.index', 'method' => 'get','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
          ...
          <div class="col-xs-12 col-sm-6 col-md-12">
              ...
              @if(in_array('subAdmin.drivers.create', $permissionData))
    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body" id="replace-div">
              @include('sub_admin.drivers.search')
        </div>
        <!-- /.box-body -->
      </div>
