<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
		...
		if(checklogin1  == true){
            ...
            url: '{{ URL::to('/sub-admin/edit-content-post') }}',
    ...
    {!! Form::open(array('url' => '/sub-admin/edit-content-post', 'method' => 'post','name'=>'editContentForm','files'=>true,'novalidate' => 'novalidate','id' => 'editContentForm')) !!}
