...
All Star Delivery | Content Manager
...
<script type="text/javascript">
    ...
    function edit_record(edit_id) {
        ...
        $('#UserModal').load('{{ URL::to('/sub-admin/edit-content') }}'+'/'+edit_id);
    ...
    function statusChange(id) 
    {
      ...
      $.ajax({
            ...
            url: '{{ URL::to('/sub-admin/content-status') }}',
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/sub-admin/content') }}');
     ...
     <div class="col-xs-12">
        <div class="box">
           ...
           <div class="box-body" id="replace-div">
              @include('sub_admin.content.search')
           </div>
           <!-- /.box-body -->
        </div>
     </div>
