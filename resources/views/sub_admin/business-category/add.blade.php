<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
		...
		if(checklogin1  == true){	
           ...
           // var name = $('#name').val();
            ...
            url: '{{ URL::to('/sub-admin/add-business-category-post') }}',
    ...
    {!! Form::open(array('url' => '/sub-admin/add-business-category-post', 'method' => 'post','name'=>'addBusinessCategoryForm','files'=>true,'novalidate' => 'novalidate','id' => 'addBusinessCategoryForm')) !!}
