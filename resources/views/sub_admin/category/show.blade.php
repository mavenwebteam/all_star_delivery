...
<script type="text/javascript">
    ...
    function add_record() {
		...
		var checklogin1 = checklogin();
		if(checklogin1  == true){
        $('#UserModal').html(''); $(".form-title").text('Add Category');

        $('#UserModal').load('{{ URL::to('/sub-admin/add-category') }}');
    ...
    function edit_record(edit_id) {
		...
		var checklogin1 = checklogin();
		if(checklogin1  == true){
        $('#UserModal').html(''); $(".form-title").text('Edit Category');

        $('#UserModal').load('{{ URL::to('/sub-admin/edit-category') }}'+'/'+edit_id);
    ...
    function view_record(view_id) {
		...
		var checklogin1 = checklogin();
		if(checklogin1  == true){
        $('#UserModal').html(''); $(".form-title").text('View Category');

        $('#UserModal').load('{{ URL::to('/sub-admin/view-category') }}'+'/'+view_id);
...

    {
      ...
      $.ajax({
            ...
            url: '{{ URL::to('/sub-admin/category-status') }}',
...
function selectImportBrand() {
    ...
    $('#UserModal').load('{{ URL::to('/sub-admin/import-category') }}');
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/sub-admin/category') }}');
      ...
      <div class="row">
        ...
        <div class="col-xs-12 page-user">
          ...
          <div class="box">
            ...
            {!! Form::open(array('url' => '/sub-admin/users', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
           ...
           <div class="col-xs-12 col-sm-6 col-md-12">
                ...
                <a href="javascript:" style="margin-top: 20px;" class="custom-btn pull-right btn btn-outline-primary btn-labeled" onclick="add_record();" title="Add Category"><span class="btn-label icon fa fa-plus"></span>Add Category</a>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" id="replace-div">
                 ...
                 @include('sub_admin.category.search')
