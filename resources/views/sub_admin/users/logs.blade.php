...
@section('title')
All Star Delivery | Customer Logs
@stop
@section('content') 
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ URL::to('/sub-admin/user-logs') }}',
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/sub-admin/orders') }}');
    })
...
<section class="" style="padding: 15px;">
      <div class="row">
        <div class="col-xs-12 page-user">
          <div class="box">
            <div class="box-body">
            {!! Form::open(array('url' => '/sub-admin/user-logs', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
...
<section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Customer Logs Table</h3>
            </div>
            <!-- /.box-header -->
    ...
    @if($i<2)
    <tr>
    <td colspan="13">No Orders Data</td>
    </tr>
    @endif    
    </tbody> 
