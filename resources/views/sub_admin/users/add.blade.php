<script type="text/javascript">
    ...
    {   
      ...
      $('#addUserForm' ).on( 'submit', function(e)
        { $.LoadingOverlay('show');
            ...
            cache: false,
            processData:false,
            url: '{{ URL::to('/sub-admin/add-user-post') }}',
        }).done(function( data ) 
 ...
 {!! Form::open(array('url' => '/sub-admin/add-user-post', 'method' => 'post','name'=>'addUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'addUserForm')) !!}
