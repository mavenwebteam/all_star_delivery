...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin:0; padding:0;">
		<table width="850px" align="center" cellpadding="0" cellspacing="0" style="background-color: #fff;border: 2px solid #bc9632;border-radius: 5px;padding: 10px;">
			<tbody>
				<tr>
					<td style="text-align: center;padding-bottom: 10px;border-bottom: 2px dotted #bc9632;">
						<!-- <a href="<?php //echo WEBSITE_URL; ?>" style="text-decoration:none;">
							<div style="" class="mws-form-row">
								<span style="font-size:34px;color:rgba(21, 100, 176, 0.9);font-weight:bold; background-color:rgba(21, 100, 176, 0.9); color:#fff; "><?php //echo Config::get("Site.title"); ?></span>
							</div>
						</a> -->
					...
					<table width="500" align="center" style="padding:15px 0;" cellpadding="0" cellspacing="0" border="0" border-spacing="0" style="border:none; border-spacing:0">
						<tr>
							...
							<td width="40%" valign="top" style=" border-spacing:0; text-align:right">
								<p style="color:#000;font-family: 'Conv_Tahoma Regular'; font-size:12px; margin:0"></p>
							</td>
						</tr>
					</table>
				</tr>
