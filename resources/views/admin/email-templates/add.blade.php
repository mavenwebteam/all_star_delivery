<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
        $( '#addContentForm' ).on( 'submit', function(e) 
        {
            ...
            type: "POST",
            url: '{{ URL::to('/admin/add-content-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/admin/add-content-post', 'method' => 'post','name'=>'addContentForm','files'=>true,'novalidate' => 'novalidate','id' => 'addContentForm')) !!}
