...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            ...
            url: '{{ URL::to('/admin/email-templates') }}',
    ...
    function edit_record(edit_id) {
        ...
        $('#UserModal').load('{{ URL::to('/admin/edit-email-templates') }}'+'/'+edit_id);
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/admin/email-templates') }}');
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" id="replace-div">
                 ...
                 @include('admin.email-templates.search')
