<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
        $( '#editCatgeoryForm' ).on( 'submit', function(e) 
        {
            ...
            type: "POST",
            url: '{{ URL::to('/admin/edit-country-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/admin/edit-country-post', 'method' => 'post','name'=>'editCatgeoryForm','files'=>true,'novalidate' => 'novalidate','id' => 'editCatgeoryForm')) !!}
                ...
                <div class="alert alert-danger" style="display:none"></div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::hidden('id',base64_encode($country_data->id),['id'=>'id']) !!}
                            {!! Form::text('name',$country_data->name, ['class' => 'form-control','placeholder' => 'Name','required'=>'required','id'=>'name','onkeypress' => 'error_remove()' ]) !!}
                            </div>
