<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
		...
		if(checklogin1  == true){
           ...
           // var id = $('#id').val();
            ...
            url: '{{ URL::to('/admin/edit-business-category-post') }}',
    ...
    {!! Form::open(array('url' => '/admin/edit-business-category-post', 'method' => 'post','name'=>'editBusinessCatgeoryForm','files'=>true,'novalidate' => 'novalidate','id' => 'editBusinessCatgeoryForm')) !!}
