...
<script type="text/javascript">
   ...
   function search() {
       $.ajax({
           type: 'POST',
           url: '{{ URL::to('/admin/business-category') }}',
...
//        window.location.href = '/karicare-admin/export-users?search_name='+UserSearchName+'&email='+UserEmail+'&mobile='+UserMobile+'&address='+UserAddress+'&created='+UserCreated+'&todate='+UserTodate+'&search_status='+UserSearchStatus;  }else{
//    location.reload();
//    $.LoadingOverlay("hide");
//    }  
//    }
   ...
   if(checklogin1  == true){
       ...
       $('#UserModal').load('{{ URL::to('/admin/add-business-category') }}');
       $("#myModal").modal();
   $.LoadingOverlay("hide");
   }else{
   location.reload();
   ...
   if(checklogin1  == true){
       ...
       $('#UserModal').load('{{ URL::to("/admin/edit-business-category") }}'+'/'+edit_id);
       $("#myModal").modal();
   $.LoadingOverlay("hide");
   }else{
   location.reload();
   ...
   if(checklogin1  == true){
       ...
       $('#UserModal').load('{{ URL::to('/admin/view-business-category') }}'+'/'+view_id);
       $("#myModal").modal();
   $.LoadingOverlay("hide");
   }else{
   location.reload();
   ...
   $('#UserModal').load('{{ URL::to("/admin/import-businees-category") }}');
   $("#myModal").modal();
   }else{
   location.reload();
   $.LoadingOverlay("hide");
   ...
   if(checklogin1  == true){
     ...
     $.ajax({
           ...
           data: { id:id}, 
           type: "POST",
           url: '{{ URL::to('/admin/business-category-status') }}',
       }).done(function( data ) 
       {   
         search();
   ...
   $(document).ready(function() {
       ...
       loadPiece( '{{ URL::to('/admin/business-category') }}');
   })
   ...
   if(checklogin1  == true){
     ...
     $.ajax({
           ...
           data: { id:id}, 
           type: "POST",
           url: '{{ URL::to('/admin/business-category-remove') }}',
       }).done(function( data ) 
       {   
         search();
          if(data.class == 'success')
...
<section class="" style="padding: 15px;">
   <div class="row">
      <div class="col-xs-12 page-user">
         <div class="box">
            <div class="box-body">
               {!! Form::open(array('url' => '/admin/country', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
      ...
      <div class="col-xs-12">
         <div class="box">
            ...
            <div class="box-body" id="replace-div">
               @include('admin.business-category.search')
            </div>
            <!-- /.box-body -->
         </div>
      </div>
