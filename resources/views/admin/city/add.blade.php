<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
        $( '#addCountryForm' ).on( 'submit', function(e) 
        {
            ...
            type: "POST",
            url: '{{ URL::to('/admin/add-city-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/admin/add-city-post', 'method' => 'post','name'=>'addCountryForm','files'=>true,'novalidate' => 'novalidate','id' => 'addCountryForm')) !!}
            ...
            <div class="panel-body">
                ...
                <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::select('country_id',$country_box,null, ['class' => 'form-control','required'=>'required','id'=>'country_id','onChange' => 'error_remove()' ]) !!}
                            </div>
