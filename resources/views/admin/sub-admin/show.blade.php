...
<script type="text/javascript">
    ...
    function add_record() {
        ...
        if(checklogin1  == true){
          $('#UserModal').html(''); $(".form-title").text('Add Sub Admin');
          $('#UserModal').load('{{ route('admin.sub-admin.create') }}');
          $("#myModal").modal();	
        } else{
          location.reload();
          $.LoadingOverlay("hide");
    ...
    function edit_record(edit_id) {
        ...
        $('#UserModal').html(''); $(".form-title").text('Edit Sub Admin');
        $('#UserModal').load('{{ URL::to('/admin/sub-admin/') }}'+'/'+edit_id+"/edit");
    ...
    function view_record(view_id) {
        ...
        $.LoadingOverlay("show");		var checklogin1 = checklogin();		if(checklogin1  == true){
        $('#UserModal').html(''); $(".form-title").text('View Sub Admin');
        $('#UserModal').load('{{ URL::to('/admin/sub-admin') }}'+'/'+view_id);
        $("#myModal").modal();		}else{			location.reload();			$.LoadingOverlay("hide");		} 
    }
    ...
    function statusChange(id) 
    {
      ...
      if(checklogin1  == true){
        ...
        $.ajax({
              ...
              data: { id:id}, 
              type: "POST",
              url: '{{ URL::to('/admin/sub-admin/status-update') }}',
          }).done(function( data ) 
          {
    ...
    $(document).ready(function() {
        loadPiece( '{{ URL::to('/admin/sub-admin') }}');
    })
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body" id="replace-div">
                 @include('admin.sub-admin.search')
            </div>
            <!-- /.box-body -->
          </div>
