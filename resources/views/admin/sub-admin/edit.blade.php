    ...
    {   $.LoadingOverlay('hide');
        ...
        {   $.LoadingOverlay('show');			var checklogin1 = checklogin();		if(checklogin1  == true){	
            ...
            $.ajax({
                    ...
                    cache: false,
                    processData:false,         
                    url: '{{ URL::to('/admin/sub-admin') }}' +'/'+ {{ $userdata->id }},
            }).done(function( data ){
                error_remove (); 
                   ...
                   {!! Form::hidden('user_id',base64_encode($userdata->id),['id'=>'user_id']) !!}
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8 col-sm-6 col-xs-12">
                                <input value="{{ $userdata->username }}" type="text" name="username" id="username" class="form-control" autocomplete="off" placeholder="Usename">
                            </div>
                        </div>
                    </div>
