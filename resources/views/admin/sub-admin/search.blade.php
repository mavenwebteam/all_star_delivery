            ...
            @foreach($userdata as $data)
               <tr>
                  ...
                  <td class="res-dropdown" style="" align="center">
                     <a href="{{ route('admin.permission.index', ['user' =>base64_encode($data->id)]) }}" target="_blank" data-toggle="tooltip" data-placement="top" title="" href="javascript:" class="btn btn-info" data-original-title="Permission"><i class="fa fa-lock" aria-hidden="true"></i></a>
