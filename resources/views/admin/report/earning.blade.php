...
<script type="text/javascript">
   ...
   function search() {
       $.ajax({
           type: 'GET',
           url: '{{ URL::to('/admin/report/earning') }}',
   ...
   function exportData() {
      ...
      if(checklogin1  == true){
         ...
         window.location.href = '{{ url('/') }}'+'/admin/report/export-earning?startDate='+startDate+'&endDate='+endDate+'&store_id='+store_id;  
      }else{
         location.reload();
         $.LoadingOverlay("hide");
      }  
      ...
      <div class="col-xs-12">
         <div class="box">
            ...
            <div class="box-body" id="replace-div">
               @include('admin.report.earning_table')
            </div>
            <!-- /.box-body -->
         </div>
      </div>
