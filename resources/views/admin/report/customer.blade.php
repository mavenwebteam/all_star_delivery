...
@section('title')
All Star Delivery | Customer Report
@stop
@section('content') 
<script type="text/javascript">
   ...
   function search() {
       $.ajax({
           type: 'GET',
           url: '{{ URL::to('/admin/report/customer') }}',
   ...
   function exportData() {
      ...
      if(checklogin1  == true){
         ...
         window.location.href = '{{ url('/') }}'+'/admin/report/export-customer?startDate='+startDate+'&endDate='+endDate;  
      }else{
         location.reload();
         $.LoadingOverlay("hide");
      }  
      ...
      <div class="col-xs-12">
         <div class="box">
            ...
            <div class="box-body" id="replace-div">
               @include('admin.report.user_table')
            </div>
            <!-- /.box-body -->
         </div>
      </div>
