...
<script type="text/javascript">
   ...
   function exportData() {
      ...
      if(checklogin1  == true){
         ...
         window.location.href = '{{ url('/') }}'+'/admin/report/export-order?start_date='+startDate+'&end_date='+endDate+'&status='+status;  
      }else{
         location.reload();
         $.LoadingOverlay("hide");
      }  
      ...
      <div class="col-xs-12">
         <div class="box">
            ...
            <div class="box-body" id="replace-div">
               @include('admin.report.order_table')
            </div>
            <!-- /.box-body -->
         </div>
      </div>
