...
<script type="text/javascript">
    ...
    function add_record() {
        ...
        $('#UserModal').load('{{ URL::to('/admin/add_return_item') }}');
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/admin/return_item') }}');
    })
...
<section class="" style="padding: 15px;">
      <div class="row">
        <div class="col-xs-12 page-user">
          <div class="box">
            <div class="box-body">
            {!! Form::open(array('url' => '/admin/return_item', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body" id="replace-div">
                 @include('admin.orders.searchreturnitem')
           </div>
            <!-- /.box-body -->
          </div>
  ...
  $(function () {
   ...
   if (r == true) {			
      ...
      $.ajax({
            ...
            type: "POST",
            url: '{{ URL::to('/admin/assign_deliveryboy') }}',
        }).done(function( data ) 
        {   
          search();
