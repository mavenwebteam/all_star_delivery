...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ URL::to('/admin/assign_delivery_boy') }}',
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/admin/assign_delivery_boy') }}');
    })
...
<section class="" style="padding: 15px;">
      <div class="row">
        <div class="col-xs-12 page-user">
          <div class="box">
            <div class="box-body">
            {!! Form::open(array('url' => '/admin/assign_delivery_boy', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body" id="replace-div">
                 @include('admin.orders.searchdeliverboy')
           </div>
            <!-- /.box-body -->
          </div>
