...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ URL::to('/admin/vendor-rating') }}',
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/admin/vendor-rating') }}');
    })

</script>
<section class="content-header"><h1>Vendor Rating<small>List</small></h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Vendor Rating Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" id="replace-div">
                 @include('admin.vendor-rating.search')
            </div>
            <!-- /.box-body -->
          </div>
