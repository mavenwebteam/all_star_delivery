     ...
     @foreach($storedata as $data)
      <tr>
         ...
         <td class="res-dropdown" style="" align="center">
            <a data-toggle="tooltip" data-placement="top" title="" href="{{ URL::to('/admin/store/edit-store') }}/{{base64_encode($data->id)}}" class="btn btn-primary" data-original-title="Edit Store"  ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
            ...
            <a data-toggle="tooltip" data-placement="top" title="" href="{{ route('admin.storeItem', $data->id) }}" target="_blank" class="btn btn-info" data-original-title="Store Menu Items"><i class="fa fa-list-alt" aria-hidden="true"></i></a>
            ...
            <a data-toggle="tooltip" data-placement="top" title="Aporve Store" href="javascript:" class="btn btn-info" data-original-title="Aporve Store" onclick="aproveStore('{{base64_encode($data->id)}}')"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>
            <?php } ?>
         </td>
      </tr>
     @endforeach
