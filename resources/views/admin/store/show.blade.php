...
<script type="text/javascript">
   ...
   { 		var checklogin1 = checklogin();		if(checklogin1  == true){
     ...
     $.ajax({
           ...
           data: { id:id}, 
           type: "POST",
           url: '{{ URL::to('/admin/store/store-remove') }}',
       }).done(function( data ) 
       {   
         search();
          if(data.class == 'success')
...
<section class="" style="padding: 15px;">
   <div class="row">
      <div class="col-xs-12 page-user">
         <div class="box">
            <div class="box-body">
               {!! Form::open(array('url' => '/admin/store', 'method' => 'post','name'=>'mySearchForm','files'=>true,'id' => 'mySearchForm')) !!}
               ...
               <div class="col-xs-12 col-sm-6 col-md-3">
                  ...
                  <a href="{{ URL::to('/admin/store/add-store') }}" style="margin-top: 20px;" class="custom-btn pull-right btn btn-outline-primary btn-labeled"  title="Add Store"><span class="btn-label icon fa fa-plus"></span> Add Store</a>
               </div>
               {!! Form::close() !!}
            </div>
            <br/>
