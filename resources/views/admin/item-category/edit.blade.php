<script type="text/javascript">
    ...
    {  $.LoadingOverlay("hide");
		...
		if(checklogin1  == true){	
            ...
            url: '{{ URL::to('/admin/edit-item-category-post') }}',
...
.users_select a {
    ...
    {!! Form::open(array('url' => '/admin/edit-item-category-post', 'method' => 'post','name'=>'editItemCatgeoryForm','files'=>true,'novalidate' => 'novalidate','id' => 'editItemCatgeoryForm')) !!}
