<script type="text/javascript">
        ...
        $( '#addbrand' ).on( 'submit', function(e)
        {
            ...
            $.ajax({
               ...
               type: "POST",
                ...
                cache: false,
                processData:false,
                url: '{{ URL::to("/admin/import-category-post") }}',
        }).done(function( data ) 
        {  
            error_remove (); 
    ...
    {!! Form::open(array('url' => '/admin/import-category-post', 'method' => 'post','name'=>'addProductInventory','files'=>true,'novalidate' => 'novalidate','id' => 'addbrand')) !!}
