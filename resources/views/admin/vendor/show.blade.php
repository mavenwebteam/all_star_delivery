@extends('layouts.adminmaster') @section('title') All Star Delivery | Vendor Manager @stop @section('content')
...
function exportData() {
	...
	window.location.href = '{{ URL::to('/admin/export-vendor') }}' + '?user_search_name=' + user_search_name + '&user_search_uniq_id=' + user_search_uniq_id + '&datepicker=' + datepicker + '&datepicker2=' + datepicker2 + '&search_user_type=' + search_user_type + '&search_user_status=' + search_user_status;
...
function add_record() {
	...
	$('#UserModal').load('{{ URL::to('/admin/add-vendor')}}');
...
function edit_record(edit_id) {
	...
	$('#UserModal').load('{{ URL::to('/admin/edit-vendor')}}'+'/'+edit_id);
...
function view_record(view_id) {
	...
	$('#UserModal').load('{{ URL::to('/admin/view-vendor') }}'+'/' +view_id);
...
function statusChange(id) {
	...
	$.ajax({
		...
		url: '{{ URL::to('/admin/vendor-status ')}}',
	...
	<div class="row">
		...
		<div class="col-xs-12 page-user">
			...
			<div class="box">
				...
				<div class="box-body"> {!! Form::open(array('url' => '/admin/search-vendor', 'method' => 'post','name'=>'mySearchForm','files'=>true,'novalidate' => 'novalidate','id' => 'mySearchForm')) !!}
					...
					<div class="col-xs-12 col-sm-6 col-md-12">
						...
						<!--<button style="margin-top: 20px;margin-left: 10px;" onclick="exportData();" class="btn btn-outline-danger pull-left" type="submit">Export</button>    --><a href="javascript:" style="margin-top: 20px;" class="custom-btn pull-right btn btn-outline-primary btn-labeled" onclick="add_record();" title="Add Vendor"><span class="btn-label icon fa fa-plus"></span> Add Vendor</a> </div> {!! Form::close() !!} </div>
	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body" id="replace-div"> @include('admin.vendor.search') </div>
