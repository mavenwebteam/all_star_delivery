       ...
       @foreach($promocodes as $value)
           <tr>
              ...
              <td class="res-dropdown" style="" align="center">
                 <button data-toggle="tooltip" data-placement="top" id="editBtn" title="Edit Promocode" class="btn btn-primary" onclick="edit_record('{{base64_encode($value->id)}}')" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
