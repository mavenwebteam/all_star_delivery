  ...
  <div class="row">
    <div class="col-xs-12 page-user">
      <div class="box">
        <div class="box-body">
          {{-- search form start --}}
          {!! Form::open(array('route' => 'vendor.menu-manager.index', 'method' => 'get','name'=>'mySearchForm','files'=>true,'id' => 'promocodeSearchForm')) !!}
    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body" id="replace-div">
              @include('admin.promocode.search')
        </div>
        <!-- /.box-body -->
      </div>
    </div>
...
$.ajaxSetup({
  ...
  //   $.ajax({
  //   type: 'GET',
  //   url:"{{ url('admin/banners?page=') }}"+pageNo,
  //   data: {},
  //   beforeSend: function(){
  //       $.LoadingOverlay("show");
  //   },
  ...
  function add_record() 
  {
    ...
    if(checklogin1  == true){
        ...
        $('#UserModal').load('{{ route("admin.promocode.create") }}');
        $("#myModal").modal();
    }else{
      location.reload();
        $.LoadingOverlay("hide");
  ...
  function edit_record(edit_id) 
  {
    ...
    if(checklogin1  == true){
        ...
        $('#UserModal').load('{{ URL::to("admin/promocode/") }}'+'/'+edit_id+'/edit');
        $("#myModal").modal();
    }else{
      location.reload();
        $.LoadingOverlay("hide");
